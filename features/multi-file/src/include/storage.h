...
//	int		   (*bs_fs_rmfs) (struct back_storage *storage);
	...
	int        (*bs_file_is_exist)(struct back_storage *storage, \
			const char *path);
	uint64_t   (*bs_file_tell)(struct back_storage *storage, bs_file_t file);
	int        (*bs_file_append)(struct back_storage *storage, bs_file_t file, \
			const char *write_buff, uint32_t write_len);
	int        (*bs_file_pread)(struct back_storage *storage , bs_file_t file, \
