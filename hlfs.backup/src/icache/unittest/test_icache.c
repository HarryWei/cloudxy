...
int main(int argc, char **argv){
	...
	g_test_add("/misc/icache_insert_1", Fixture, NULL, case_setup, \
			test_icache_insert_1, case_teardown);
	g_test_add("/misc/icache_insert_2", Fixture, NULL, case_setup,\ 
			test_icache_insert_2, case_teardown);
	g_test_add("/misc/icache_query_1", Fixture, NULL, case_setup, \
			test_icache_query_1, case_teardown);
	g_test_add("/misc/icache_query_2", Fixture, NULL, case_setup, \
			test_icache_query_2, case_teardown);
